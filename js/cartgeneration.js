function connection(){
            var doc = document.getElementById("comission").contentDocument;
            var Items = doc.getElementsByTagNameNS("http://example.mozilla.org/PurchaseOrderML", "product");
...
var d = document,
    itemBox = d.querySelectorAll('.main-cart-hover'), // блок каждого товара
		cartCont = d.getElementById('content'); // блок вывода данных корзины
